...
## Project Structure
    ...
    ├── gentle_snowflake_d_104489  # Django project configurations
...
1. Clone this repo and `cd gentle_snowflake_d_104489`
...
2. Clone this repo and `cd gentle_snowflake_d_104489`
